...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            LCD_drawString(1, 40, msg, WHITE, BLACK);
            
            sprintf(msg, "GX = %1.3f  ", xGyro);
            LCD_drawString(1, 60, msg, WHITE, BLACK);
            sprintf(msg, "GY = %1.3f  ", yGyro);
            LCD_drawString(1, 70, msg, WHITE, BLACK);
            sprintf(msg, "GZ = %1.3f  ", zGyro);
            LCD_drawString(1, 80, msg, WHITE, BLACK);            
